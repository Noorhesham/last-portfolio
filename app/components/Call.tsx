...
function CallMe() {
  ...
  return (
    <MaxWidthWrapper id="CallMe" className="  z-[9998]  relative flex justify-center    overflow-hidden">
      <motion.div
        className=" w-full flex items-center lg:items-start gap-20 lg:flex-row flex-col "
        variants={variants}
        initial="initial"
        whileInView="animate"
      >
        <motion.div className=" w-full flex-col  text-gray-200 z-40  dark:text-gray-200 gap-4 flex  capitalize ">
          <motion.h1
            className=" text-[#5629d9] text-xl lg:text-4xl xl:text-5xl font-semibold mb-5 "
            variants={variants}
          >
            Call Me me now !
          </motion.h1>
